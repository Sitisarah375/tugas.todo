...
<body style="background-image: url('https://img.freepik.com/free-vector/hand-painted-watercolor-pastel-sky-background_23-2148902771.jpg?w=2000')">
    ...
    <div class="container vh-100">
        ...
        <div class="row">
            <div class="col-6" style="margin-top: 125px" >
                <img src="{{ asset('assets/img/sarahh.png')}}" alt="" style="width:500px">
            </div> 
            <div class="col-lg">             
                                <div class="p-5">
                                    ...
                                    <form class="user" action="{{route('register-input')}}" method="POST">
                                        ...
                                        <button type="submit" class="btn btn-success btn-user btn-block" type="submit">Register</button>
                                    </form>
                                    <hr>
                                    <div class="text-center">
